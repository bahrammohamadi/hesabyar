...
export const FALLBACK_PLANS: MarketingPlan[] = [
  ...
  },
  {
    ...
    /*
      🔴 «پنل پیامکی رایگان» حذف شد: هیچ سرویس پیامکی به برنامه وصل
      نیست. جستجوی کد نشان داد تنها چیز موجود، لینک `sms:` روی شماره‌ی
      مخاطب است که خودِ گوشی باز می‌کند — نه پنل ارسال انبوه.
    */
    features: ["محصولات نامحدود", "مدیریت کامل انبارداری", "پشتیبان‌گیری کامل اکسل", "۱۵٪ تخفیف اقتصادی"],
    featured: true,
    cta: "خرید اشتراک",
    href: "/register",
  },
