...
const AUDIENCES = [
  ...
  /*
    🔴 «فروش اقساطی» از این متن حذف شد چون وجود ندارد. ما فقط «نسیه»
    داریم — یک مبلغ بدهی بدون زمان‌بندی. دفترچه‌ی اقساط با سررسید،
    کارمزد و جریمه‌ی دیرکرد (که رقبا دارند) پیاده‌سازی نشده است.
    وعده‌ی قابلیتی که نیست، بدترین نوع بدهی است.
  */
  { title: "لوازم خانگی و دیجیتال", body: "فروش نسیه، ثبت چک و پیگیری مانده‌ی حساب مشتریان." },
];
