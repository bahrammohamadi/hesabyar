...
function brandScale(primary: string[], accent: string[]) {
  return {
    "--brand-50": primary[0],
    "--brand-100": primary[1],
    "--brand-200": primary[2],
...
export const THEMES: ThemeDefinition[] = [
  {
    ...
    vars: brandScale(
      ["233 244 240", "200 227 218", "159 205 191", "111 179 160", "68 150 131", "31 122 102", "19 100 81", "15 79 65", "12 63 52", "10 51 43"],
  ...
  },
  {
    id: "copper",
    name: "گرم و لوکس",
    description: "قهوه‌ای/مسی مناسب پوشاک و بوتیک",
    swatches: ["#92400e", "#78350f", "#be123c"],
    vars: brandScale(
      ["255 251 235", "254 243 199", "253 230 138", "252 211 77", "245 158 11", "217 119 6", "180 83 9", "146 64 14", "120 53 15", "69 26 3"],
